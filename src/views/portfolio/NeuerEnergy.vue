  ...
  <v-container>
    <v-row class="text-left">
      <v-col cols="12">
        ...
        <v-img :src="`${hero}`" class="mt-10 img" alt="core NeuerEnergy Scenario Analysis page"></v-img>
        <h1
          class="display-2 font-weight-bold mb-3 mt-10"
        >NeuerEnergy.</h1>
        <h2
          class="headline mb-3 mt-2"
        >Removing the barriers to corporate carbon neutrality.</h2>
      </v-col>
    </v-row>
    <v-row class="text-left">
      <v-col cols="12">
        ...
        <h3 class="mb-4 mt-8">What is it?</h3>
          ...
          <section aria-label="summary">
            ...
            <p>
                The project is still in active development but is nearing its alpha launch.
            </p>
        </section>
      </v-col>
    </v-row>
...
export default {
  ...
  data() {
    return {
      ...
      hero: "https://res.cloudinary.com/kejk/image/upload/v1583874990/NeuerEnergy_Header_meopqr.png",
    };
  }
};
</script>