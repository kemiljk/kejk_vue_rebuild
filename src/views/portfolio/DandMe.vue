  ...
  <v-container>
    <v-row class="text-left">
      <v-col cols="12">
        ...
        <v-img
          :src="`${hero}`"
          class="mt-10 img"
          alt="image of duchenne and me app in use"
        />
        <h1
    ...
    <v-row class="text-left">
      <v-col cols="12">
        ...
        <p>
          We were a small team when we started the app project so I had to be flexible in how I supported the wider team. My involvement covered a wide spectrum from research, wireframing and prototyping, through to the final information
