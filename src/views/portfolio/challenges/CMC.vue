  ...
  <v-container>
    <v-row class="text-left">
      <v-col cols="12">
        ...
        <p class="mb-4">As a user, particularly a new user, based on placement and my historic experience with buttons placed next to items, I expect that the plus button’s behaviour is directly tied to the label to its left.</p>
