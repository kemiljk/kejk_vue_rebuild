  ...
  <v-container>
    <v-row class="text-left ml-1 mr-1">
      <v-col cols="12">
        ...
        <v-btn color="teal" class="mt-4" href="https://res.cloudinary.com/kejk/image/upload/v1584313703/Karl_Koch_CV_2020_gwzx9d.pdf" target="_blank" ref="noreferrer"><v-icon class="mr-2">mdi-file</v-icon>Resumé</v-btn>
      </v-col>
    </v-row>
