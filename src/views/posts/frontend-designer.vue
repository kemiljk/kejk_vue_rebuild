<template>
  <v-container>
    ...
    <v-row class="text-left">
      <v-col cols="12">
        <p>So let's start with some background; I've been tinkering with website code since the early 2000's when MySpace was first on the scene and I was trying to customise the look of my personal MySpace page.</p>
        ...
        <p>The more I did it, the more I enjoyed the experience of designing in the browser. I'm not saying you should go away completely from using design tools (I still heavily use <a
            href="https://adobe.com/xd"
            target="_blank"
            class="teal--text"
          >Adobe XD</a> and <a
            href="http://figma.com"
            target="_blank"
            class="teal--text"
          >Figma</a>), but I am saying that understanding how to design in code is a super power that all digital designers should aim to posess.</p>
        <p>Here are the key reasons why:</p>
        <ol class="mb-3">
          <li>You can see the direct effect of a decision, in the browser, in real time</li>
          <li>You can learn the langauge of development, allowing for better cross-communication between you and your development team</li>
